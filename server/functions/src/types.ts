...
export interface RequirementOfReGenerateSerialNumber {
  readonly jwtToken: string,
  machine: string,
  expire: number,
}
...
export interface GuestUser {
  serialNumber: string,
  expire: number,
  reGenerateSerialNumberTime: number,
  position: string,
  role: string
}

export interface RequirementOfQueryAllStaff {
  readonly jwtToken: string
}

export interface RequirementOfQueryAllGuest {
  readonly jwtToken: string
}

export interface RequirementOfQuerySpecificUser {
  readonly jwtToken?: string,
  readonly serialNumber?: string,
  readonly uid?: string
}

export interface RequirementOfDeleteSpecificStaff {
  readonly jwtToken: string,
  readonly uid: string
}

export interface RequirementOfDeleteSpecificGuest {
  readonly jwtToken: string,
 ...
 * password <string> The user's raw, un-hashed password. Must be at least six characters long.
